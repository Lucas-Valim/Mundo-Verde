...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <br>
            <h5>Descartando com consciência</h5>
            <!-- Icon Divider-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto">
                    <p class="lead">O objetivo desse site é ser um portal com dicas e matérias sobre descartes de resíduos
                        hospitalares.
                        O site permite que seu usuário cadastre um login para buscar
                        os melhores lugares para descartar os resíduos hospitalares. Vai ser um projeto que
                        estimula a correta destinação de resíduos que com a pandemia houve um maior aumento, como
                        seringas, potes de vacinas, remédios, mascaras e etc. </p>
                </div>
                <div class="col-lg-4 mr-auto">
                    <p class="lead">
                        Além disso,
                        tem matérias relevantes e dicas de como obter hábitos mais sustentáveis e ecológicos.</p>
                </div>
            </div>
        </div>
    </section>
